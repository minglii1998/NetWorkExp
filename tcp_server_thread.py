...
sockSrv.listen(5)
sockCli,addr = sockSrv.accept()
ta = threading.Thread(target=athread,args=(sockCli,addr))
ta.start()
sockSrv.close()
...
sockSrv.listen(5)
sockCli,addr = sockSrv.accept()
tb = threading.Thread(target=athread,args=(sockCli,addr))
tb.start()
sockSrv.close()
...
sockSrv.listen(5)
sockCli,addr = sockSrv.accept()
tc = threading.Thread(target=athread,args=(sockCli,addr))
tc.start()
sockSrv.close()
